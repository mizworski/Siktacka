...
void parse_arguments(int argc, char **argv, std::string &player_name, std::string &game_server_host,
                     int64_t &game_server_port, std::string &ui_server_host, int64_t &ui_server_port);
...
int main(int argc, char **argv) {
    ...
    int64_t game_server_port = 12345;
    int64_t ui_server_port = 12346;
...
void parse_arguments(int argc, char **argv, std::string &player_name, std::string &game_server_host,
    ...
    if (game_server_host.find(":") != std::string::npos) {
        ...
        game_server_port = atoi(game_server_port_str.c_str());
    ...
    if (argc == 4) {
        ...
        if (ui_server_host.find(":") != std::string::npos) {
            ...
            ui_server_port = atoi(ui_server_port_str.c_str());
